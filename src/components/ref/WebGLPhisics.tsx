  ...
  return (
    <>
      ...
      <mesh ref={ref}>
        ...
        <meshPhysicalMaterial map={useTexture("/cross.jpeg")} transmission={1} roughness={0} thickness={10} envMapIntensity={1} />
      </mesh>
    </>
  )
}
...
const Background = (props) => (
  <mesh scale={useAspect(5000, 3800, 3)} {...props}>
    <planeGeometry />
    <meshBasicMaterial map={useTexture("/pop.jpeg")} />
  </mesh>
)

export const WegGLPhisics = () => {
  return (
    <Canvas dpr={1.5} camera={{ position: [0, 2, 12], fov: 50 }} style={{ width: '1200px', height: '800px' }}>
